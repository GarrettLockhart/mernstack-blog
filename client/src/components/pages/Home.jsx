  ...
  return (
    <div>
      <div className='flex flex-col justify-start items-center h-[23vh] bg-c-blue'>
        <div>
          <h2 className='text-center text-white lg:text-6xl text-5xl mt-24'>
            Welcome to{' '}
            <span className='custom-logo lg:text-7xl text-6xl text-white'>Hackit</span>
          </h2>
      ...
      <div>
        <section className='grid lg:grid-cols-3 md:grid-rows-2 grid-cols-1 p-10 w-full lg-w-4/5 lg:mx-auto h-auto'>
          <div
